...
H1 = 32                 # hidden layer 1 width
H2 = 32                 # hidden layer 2 width
...
if __name__ == "__main__":
    ...
    try:
        canvas_out.snap_right(canvas_in)
        canvas_w1.snap_right(canvas_out)
        canvas_w2.snap_right(canvas_w1)
        canvas_w3.snap_right(canvas_w2)
    except Exception:
        pass
